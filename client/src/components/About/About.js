        ...
        <Columns.Column>
          <div className="about-description">
            ...
            <p className="about-content">
              Descriptor uses a state-of-the-art Natural Language Processing
              (NLP) algorithm to process text to rank the most significant so
              you can get the most out of any piece of information
            </p>
          </div>
        </Columns.Column>
        <Columns.Column>
